			...
			<div class="post-onelist-item tweet">
				<div class="post-tweet-item-container">
					<div class="tweet-item-info">
						...
						<div class="item-meta">
							<time datetime="<?php $this->date('c'); ?>" itemprop="datePublished"><span class="bold"><?php $this->date('M'); ?></span><?php $this->date(' j, Y H:i'); ?></time>
						</div>
					</div>
				</div>
			</div>
        	...
        	<?php endif; ?>
					...
					<div class="onelist-item-info">
						...
						<div class="item-readmore">
							<a href="<?php $this->permalink(); ?>"><i class="fas fa-arrow-right"></i> MORE </a>
						</div>
					</div>
				</div>
			</div>
