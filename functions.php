...
function themeConfig($form) {
    ...
    $useHighlineCSS = new Typecho_Widget_Helper_Form_Element_Select('useHighlineCSS',
        array('default' => _t('Default'),
            'a11y-dark' => _t('A 11 Y Dark'),
            'a11y-light' => _t('A 11 Y Light'),
            'agate' => _t('Agate'),
            'an-old-hope' => _t('An Old Hope'),
            'androidstudio' => _t('Androidstudio'),
            'arduino-light' => _t('Arduino Light'),
            'arta' => _t('Arta'),
            'ascetic' => _t('Ascetic'),
            'atelier-cave-dark' => _t('Atelier Cave Dark'),
            'atelier-cave-light' => _t('Atelier Cave Light'),
            'atelier-dune-dark' => _t('Atelier Dune Dark'),
            'atelier-dune-light' => _t('Atelier Dune Light'),
            'atelier-estuary-dark' => _t('Atelier Estuary Dark'),
            'atelier-estuary-light' => _t('Atelier Estuary Light'),
            'atelier-forest-dark' => _t('Atelier Forest Dark'),
            'atelier-forest-light' => _t('Atelier Forest Light'),
            'atelier-heath-dark' => _t('Atelier Heath Dark'),
            'atelier-heath-light' => _t('Atelier Heath Light'),
            'atelier-lakeside-dark' => _t('Atelier Lakeside Dark'),
            'atelier-lakeside-light' => _t('Atelier Lakeside Light'),
            'atelier-plateau-dark' => _t('Atelier Plateau Dark'),
            'atelier-plateau-light' => _t('Atelier Plateau Light'),
            'atelier-savanna-dark' => _t('Atelier Savanna Dark'),
            'atelier-savanna-light' => _t('Atelier Savanna Light'),
            'atelier-seaside-dark' => _t('Atelier Seaside Dark'),
            'atelier-seaside-light' => _t('Atelier Seaside Light'),
            'atelier-sulphurpool-dark' => _t('Atelier Sulphurpool Dark'),
            'atelier-sulphurpool-light' => _t('Atelier Sulphurpool Light'),
            'atom-one-dark-reasonable' => _t('Atom One Dark Reasonable'),
            'atom-one-dark' => _t('Atom One Dark'),
            'atom-one-light' => _t('Atom One Light'),
            'brown-paper' => _t('Brown Paper'),
            'codepen-embed' => _t('Codepen Embed'),
            'color-brewer' => _t('Color Brewer'),
            'darcula' => _t('Darcula'),
            'dark' => _t('Dark'),
            'darkula' => _t('Darkula'),
            'docco' => _t('Docco'),
            ...
            'github' => _t('Github'),
            'gml' => _t('Gml'),
            'googlecode' => _t('Googlecode'),
            'gradient-dark' => _t('Gradient Dark'),
            'grayscale' => _t('Grayscale'),
            'gruvbox-dark' => _t('Gruvbox Dark'),
            'gruvbox-light' => _t('Gruvbox Light'),
            'hopscotch' => _t('Hopscotch'),
            'hybrid' => _t('Hybrid'),
            'idea' => _t('Idea'),
            'ir-black' => _t('Ir Black'),
            'isbl-editor-dark' => _t('Isbl Editor Dark'),
            'isbl-editor-light' => _t('Isbl Editor Light'),
            'kimbie.dark' => _t('Kimbie Dark'),
            'kimbie.light' => _t('Kimbie Light'),
            'lightfair' => _t('Lightfair'),
            'magula' => _t('Magula'),
            ...
            'nord' => _t('Nord'),
            'obsidian' => _t('Obsidian'),
            'ocean' => _t('Ocean'),
            'paraiso-dark' => _t('Paraiso Dark'),
            'paraiso-light' => _t('Paraiso Light'),
            'pojoaque' => _t('Pojoaque'),
            'purebasic' => _t('Purebasic'),
            'qtcreator_dark' => _t('Qtcreator Dark'),
            'qtcreator_light' => _t('Qtcreator Light'),
            'railscasts' => _t('Railscasts'),
            'rainbow' => _t('Rainbow'),
            'routeros' => _t('Routeros'),
            'school-book' => _t('School Book'),
            'shades-of-purple' => _t('Shades Of Purple'),
            ...
            'tomorrow-night-bright' => _t('Tomorrow Night Bright'),
        ...
        'solarized-light', _t('代码高亮样式设置'), _t('默认Solarized Light'));
    $form->addInput($useHighlineCSS);
